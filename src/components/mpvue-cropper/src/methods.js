...
export default function methods () {
  ...
  let { x = 0, y = 0, width = boundWidth, height = boundHeight, multiple = 3 } = self.cut
    ...
    switch (ARG_TYPE) {
      case '[object Object]':
        ...
        wx.canvasToTempFilePath({
          ...
          width,
          height,
          destWidth: width * quality / (deviceRadio * 10) * multiple,
          destHeight: height * quality / (deviceRadio * 10) * multiple,
          success (res) {
      ...
      case '[object Function]':
        wx.canvasToTempFilePath({
          ...
          width,
          height,
          destWidth: width / deviceRadio * multiple,
          destHeight: height / deviceRadio * multiple,
          success (res) {
            isFunction(fn) && fn.call(self, res.tempFilePath)
          },
          fail (res) {
